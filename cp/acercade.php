...
if (!isset($_SESSION['type'])) {
  ...
  $title = "Acerca de Pharos CMS";
  disp_header_admin($pre,$title);
  include('inc/menu_admin.inc.php');
  disp_inicio_info($title,'acercade');
?>
    <fieldset>
      <legend><span class="acercade">Acerca de Pharos CMS</span></legend>
      <p>Información sobre la creación del Sistema de Administración de Contenido Pharos CMS.</p>
      <div class="descrip">
        <p>Información sobre la creación del Sistema de Administración de Contenido Pharos CMS.</p>
        <p>&nbsp;</p>
        <p>&nbsp;</p>
