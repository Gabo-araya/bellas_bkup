...
$title = "Proceso de Creación de Agua Pura";
$secc = "info_".$self;
...
?>
      ...
      <?php if (!empty($_SESSION)) {echo "<div class=\"box_warning\">".disp_array_asoc($_SESSION)."</div>";} ?>
       <p>Esta es una animación del proceso de creación de Agua Pura. Las etapas del proceso se explican a continuación. </p>
         <p>&nbsp;</p>           <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=6,0,29,0" height="334" width="465">
           <param name="movie" value="img/proceso_aguapura.swf">
             <param name="quality" value="high">
             <embed src="img/proceso_aguapura.swf" quality="high" pluginspage="http://www.macromedia.com/go/getflashplayer" type="application/x-shockwave-flash" height="334" width="465">
           </object>
         <p>&nbsp;</p>
<?php
  echo $txt;
